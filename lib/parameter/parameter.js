...
var Parameter = function (){
    ...
    this.isSchemaMongoose = function(obj){
        ...
        if(obj.type && (obj.ref!== undefined || obj.enum !== undefined ||  obj.default !== undefined || obj.required !== undefined || obj.auto) ){
    ...
    this.mongooseParser = function(model){
        ...
        console.log(tiper.getPrimitive(model));
        console.log(model.type);
        console.log(self.isSchemaMongoose(model));
        if(tiper.getPrimitive(model) !== 'model' && self.isSchemaMongoose(model) ){
            ...
            fieldSchema.required = model.required || fieldSchema.required;
